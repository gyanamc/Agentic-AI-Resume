    ...
    <div className="glass-panel" style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        <div style={{ flex: 1, padding: '40px', position: 'relative', overflowY: 'auto' }}>
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '40px', alignItems: 'center' }}>
          ...
          <svg style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: -1 }}>
             ...
             {/* Note: In a real app we would dynamically draw lines between refs, but CSS grouping provides the visual structure here */}
          </svg>
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center' }}>
        <div style={{ fontWeight: 'bold', fontSize: '16px', color: isSelected ? '#fff' : 'var(--text-primary)' }}>{node.title}</div>
